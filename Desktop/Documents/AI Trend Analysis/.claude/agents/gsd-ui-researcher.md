...
Use template from `/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
