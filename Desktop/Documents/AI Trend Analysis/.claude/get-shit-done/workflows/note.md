...
- **Global scope**: `/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/notes/`)
...
2. Glob `/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alvins/Desktop/Documents/AI Trend Analysis/.claude/notes/` — works in any directory
